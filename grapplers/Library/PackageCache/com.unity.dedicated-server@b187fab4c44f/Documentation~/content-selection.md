...
In your multiplayer project, you can use [multiplayer roles](multiplayer-roles.md) to define which Game Objects and Components exist on the client, the server, or both. For example, you can use this functionality to do the following:
